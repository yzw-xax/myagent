...
def _setup_workspace():
    ...
    Mirrors a real Agent workspace closely enough that the model has genuine
...
if __name__ == "__main__":
    if "--debug" in sys.argv:
        import logging
        from common.log import logger as _myclaw_logger
        _myclaw_logger.setLevel(logging.DEBUG)
        for _h in _myclaw_logger.handlers:
