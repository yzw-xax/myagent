...
class ChatChannel(Channel):
    ...
    def _decorate_reply(self, context: Context, reply: Reply) -> Reply:
        if reply and reply.type:
            ...
            if not e_context.is_pass() and reply and reply.type:
                ...
                elif reply.type == ReplyType.IMAGE_URL or reply.type == ReplyType.IMAGE or reply.type == ReplyType.FILE or reply.type == ReplyType.VIDEO or reply.type == ReplyType.VIDEO_URL:
                    pass
                else:
    ...
    # Use /cancel (not /stop) to avoid colliding with `myclaw stop` CLI.
