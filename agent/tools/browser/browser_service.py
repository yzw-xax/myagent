...
_DEFAULT_USER_DATA_DIR = "~/.myclaw/browser_profile"
...
class BrowserService:
    ...
    def _launch_browser(self):
        ...
        # bundled-Chromium fallback finds the browser downloaded to ~/.myclaw.
        try:
        ...
        try:
            ...
            if "singletonlock" in msg or "profile" in msg or "lock" in msg:
                raise RuntimeError(
                    ...
                    "Close the other Chromium / myclaw instance, or set a different "
