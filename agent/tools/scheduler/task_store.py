...
class TaskStore:
    ...
    def __init__(self, store_path: str = None):
        ...
        Args:
            store_path: Path to tasks.json file. Defaults to ~/myclaw/scheduler/tasks.json
        """
        if store_path is None:
            # Default to ~/myclaw/scheduler/tasks.json
            home = expand_path("~")
            store_path = os.path.join(home, "myclaw", "scheduler", "tasks.json")
