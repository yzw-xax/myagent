...
class AgentStreamExecutor:
    ...
    def _select_tools_for_injection(self) -> list:
        """Return all available tools to inject into the current LLM turn."""
    ...
    def _call_llm_stream(self, retry_on_empty=True, retry_count=0, max_retries=3,
        ...
        # fall back to the static `tool.params`.
        tools_schema = None
        if self.tools:
            tools_schema = []
        ...
        try:
            ...
            for chunk in stream:
                ...
                if isinstance(chunk, dict) and chunk.get("choices"):
                    ...
                    # (direct Gemini: list of parts; proxy: base64 string of JSON parts)
