...
Storage path: ~/myclaw/sessions/conversations.db
"""
...
# Generic JSON sidecar for per-message attachments.
...
class ConversationStore:
    ...
    def attach_extras_to_last_assistant(
        ...
        Used by post-processing that needs to annotate an already
...
def get_conversation_store() -> ConversationStore:
    ...
    SQLite file: ~/myclaw/memory/long-term/index.db
    ...
    with _store_lock:
        ...
        try:
            ...
            db_path = Path(expand_path("~/myclaw")) / "memory" / "long-term" / "index.db"
