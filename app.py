...
# loaded in a background thread (so command plugins like myclaw_cli/godcmd work
        ...
        with self._lock:
            ...
            if first_start:
                if DESKTOP_MODE:
                    ...
                    # (myclaw_cli / godcmd, e.g. /status, #help) work in the
                ...
                # Cloud client is no longer supported.
...
def _sync_builtin_skills():
    ...
    import shutil
    try:
        workspace = conf().get("agent_workspace", "~/myclaw")
